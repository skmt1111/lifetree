...
class TreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tree" do
    assert_difference('Tree.count') do
      post trees_url, params: { tree: { content: @tree.content, special_date: @tree.special_date, title: @tree.title, user_id: @tree.user_id } }
    end
  ...
  test "should update tree" do
    patch tree_url(@tree), params: { tree: { content: @tree.content, special_date: @tree.special_date, title: @tree.title, user_id: @tree.user_id } }
